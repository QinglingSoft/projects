...
<head>
	...
	<link href="css/binghaiAdderSelector.css.jsp?SBJGXS=${data['SBJGXS']}" rel="stylesheet" type="text/css" />
...
<ul class="briefTree">
	<briefTree:item catalog="病害记录" brief="${data}" dataTable="${dataTable}"/>
</ul>
